...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_testdriver_template" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#afe94f15#;
   pragma Export (C, u00001, "main_ada_testdriver_templateB");
   ...
   --  main_ada_testdriver_template%b
